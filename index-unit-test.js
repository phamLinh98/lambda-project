...
const result1 = solveQuadraticEquation(a, b, c);
if (result1 === "Không phải phương trình bậc hai.") {
...
const b4 = 2;
const c4 = 1;
// Kết quả mong đợi: Các hệ số a, b, c phải là số.
const result4 = solveQuadraticEquation(a4, b4, c4);
if (result4 === "Các hệ số a, b, c phải là số.") {
